          ...
          <div className='p-8 pt-12 flex flex-col items-center'>
            ...
            >
              ...
              <div className='flex items-center justify-between text-sm font-semibold'>
                <label className='flex items-center text-slate-600 cursor-pointer'>
                  <input
                    {...register('rememberMe')}
                    type='checkbox'
                    className='mr-2 h-4 w-4 text-blue-600 rounded border-slate-300'
                  />
                  Remember me
                </label>
                <Link
              ...
              <button
                disabled={isLoading}
                type='submit'
                className='w-full bg-[#1d61f2] hover:bg-blue-700 text-white font-bold py-3.5 rounded-lg flex justify-center items-center transition-all shadow-md'
              >
                {isLoading ? (
            ...
            <div className='relative w-full my-8 text-center border-b border-slate-200 leading-[0.1em]'>
              <span className='bg-white px-3 text-slate-400 text-[10px] font-bold uppercase tracking-widest'>
                Or continue with
              </span>
            </div>
